...
const AdminNotificationBell: React.FC = () => {
  const { adminNotifications, markAdminNotificationAsRead } = useData();
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative p-2.5 rounded-lg bg-dark-card border border-dark-border text-dark-secondary hover:text-dark-primary transition-colors"
      >
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-80 bg-dark-card border border-dark-border rounded-xl shadow-2xl z-30 animate-fade-in p-2">
          <div className="p-2 border-b border-dark-border flex justify-between items-center">
            <h4 className="font-bold text-dark-text">Notificações Admin</h4>
